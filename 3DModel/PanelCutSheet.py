...
if __name__ == '__main__':
    ...
    doc.SmallCutPanelPage_1.addView(doc.Bottom_Panel)
    ...
    doc.SmallCutPanelPage_1.addView(doc.Bottom_Left)
    ...
    doc.SmallCutPanelPage_1.addView(doc.Bottom_Right)
    ...
    doc.SmallCutPanelPage_1.addView(doc.Bottom_Front)
    ...
    doc.SmallCutPanelPage_1.addView(doc.Bottom_Back)
    ...
    doc.SmallCutPanelPage_2.addView(doc.Middle_Panel)
    doc.Middle_Panel.Source = middlePanel
    doc.Middle_Panel.X = 6.35+panel_centerX
    doc.Middle_Panel.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_2.addView(doc.Middle_Left)
    ...
    doc.Middle_Left.X = 6.35+PortableM64CaseCommon._Height+\
                         ...
                         6.35
    doc.Middle_Left.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_2.addView(doc.Middle_Right)
    ...
    doc.Middle_Right.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_2.addView(doc.Middle_Front)
    ...
    doc.Middle_Front.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_2.addView(doc.Middle_Back)
    ...
    doc.Middle_Back.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_3.addView(doc.Top_Panel)
    doc.Top_Panel.Source = topPanel
    doc.Top_Panel.X = 6.35+panel_centerX
    doc.Top_Panel.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_3.addView(doc.Keyboard_Shelf)
    ...
    doc.Keyboard_Shelf.X = 6.35+PortableM64CaseCommon._Height+\
                     ...
                     6.35
    doc.Keyboard_Shelf.Y = 6.35+panel_centerY
    ...
    doc.SmallCutPanelPage_2.addView(doc.Battery_Panel)
    ...
    doc.Battery_Panel.Y = 6.35+panel_centerY
    doc.Battery_Panel.Rotation = 90.0
    doc.Battery_Panel.Direction = (0.0,0.0,1.0)
    #
    doc.recompute()
    TechDrawGui.exportPageAsSvg(doc.SmallCutPanelPage_1,"BananaPiM64Model_Page1.svg")
    TechDrawGui.exportPageAsSvg(doc.SmallCutPanelPage_2,"BananaPiM64Model_Page2.svg")
    TechDrawGui.exportPageAsSvg(doc.SmallCutPanelPage_3,"BananaPiM64Model_Page3.svg")
    sys.exit(1)
